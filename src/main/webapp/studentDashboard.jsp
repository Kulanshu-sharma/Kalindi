...
<script src="HPMSKiosk.js"></script>
...
<body>
      ...
      <div class="container-fluid">
        ...
        <ul class="navbar-nav align-items-center d-none d-md-flex">
          <li class="nav-item dropdown">
            <button class="nav-link pr-0" onclick="logout();" role="button" aria-haspopup="true">
            ...
            <div class="card-body pt-0 pt-md-4">
              <div class="row">
                <div class="col">
                  <div class="card-profile-stats d-flex justify-content-center mt-md-5">
                    ...
                    <div>
                      <span class="heading"><%=StudentDashboardBB.semester%></span>
                      <span class="description">Vacant</span>
                    </div>
                    <div>
                      <span class="heading"><%=StudentDashboardBB.semester%></span>
                      <span class="description">Emergency</span>
                    </div>
                  </div>
                </div>
              </div>
              <div class="text-center">
                ...
                <div class="h5 font-weight-300">
                  <i class="ni location_pin mr-2"></i><%=StudentDashboardBB.phoneNo%>
                </div>
                <div class="h5 mt-4">
                ...
                <hr class="my-4">
                <p><%=StudentDashboardBB.studentName%> you are allowed to Book any Appointment with any date for the next 3 days only. You are also Permitted to cancel the appointment.</p>
  ...
  <tr>
    ...
    <td style="color:<%=data.getStatusColor()%>;"><%=data.getStatus()%></td>
  </tr>
  <%} }%>
 </table>
